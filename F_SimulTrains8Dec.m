function [ResP ResM PR11 PR22 PR34 UU People Mossies ]= F_SimulTrains8Dec(ND,NP,NM,Param,PR11,PR22,PR34,UU);
% 
...
[People Mossies]=F_Initialize7Dec(ND,NP,NM,N0,D1,D2,D3);
[NPP nn]=size(People);
[NMM mm]= size(Mossies);
